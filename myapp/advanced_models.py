...
class MalwareSignature(models.Model):
    ...
    sha256 = models.CharField(max_length=128, unique=True, db_index=True)
...
class FileReputation(models.Model):
    ...
    verdict = models.CharField(
        max_length=20, choices=VERDICT_CHOICES, default="UNKNOWN"
    )
...
class ProcessAnalysis(models.Model):
    ...
    threat_type = models.CharField(max_length=50, choices=PROCESS_THREATS)
...
class IPReputation(models.Model):
    ...
    threat_level = models.CharField(
        max_length=20, choices=THREAT_LEVELS, default="CLEAN"
    )
